...
<div class="col-md-10 offset-md-1 ">
    ...
    <div class="row g-12">
        ...
        <div class="col-lg-6 col-sm-12 col-md-12 pt-2 ">
            ...
            <p class="txt_dados_empresa vertical-align-middle">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-border-style" viewBox="0 0 16 16">
            ...
            @endif
            <h5 class="events-owner pt-2 vertical-align-middle">
    ...
    <div class="row g-12"> 
        ...
        <div class="col-lg-6 col-sm-12 col-md-12 pt-2 pt-3 "  > 
            ...
            <div class="col-lg-6 col-sm-12 col-md-12 pt-2 pt-4 "  > 
