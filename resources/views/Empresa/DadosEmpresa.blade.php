    ...
    <div class="row g-12"> 
        <div class="col-lg-6 col-sm-12 col-md-12 pt-5 "  > 
            <div class="card">
                ...
                <div class="card-body">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3856.!2d{{ $empresa->longitude }}!3d{{ $empresa->latitude }}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x7463b12bfda1035%3A0x373937af9e59ad56!2s{{ $empresa->logradouro }}%20%2C%20{{ $empresa->numero_endereco }}%20-%20{{ $empresa->bairro }}%2C%20{{ $empresa->cidade }}%20-%20{{ $empresa->uf }}%2C%2045065-000!5e0!3m2!1spt-BR!2sbr!4v1675985984301!5m2!1spt-BR!2sbr" width="100%" height="100%" style="border:0;  border-radius: 10px  ;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                        ...
                        <div class="row g-12"> 
                            ...
                            <div class="col-4 pt-2"> 
                                <a href="{{$empresa->instagram}}" 
                                    class="btn btn-info btn-sm vertical-align-middle " 
                                    data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                    data-bs-title=""
                                    target="_blank">
                            ...
                            <div class="col-4 pt-2"> 
                                <a href="{{$empresa->youtube}}" 
                                    class="btn btn-danger btn-sm vertical-align-middle" 
                                    data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                    data-bs-title=""
                                    target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube mx-1" viewBox="0 0 16 16">
                            ...
                            <div class="col-4 pt-2 "> 
                                <a href="{{$empresa->facebook}}" 
                                    class="btn btn-primary btn-sm vertical-align-middle" 
                                    data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                    data-bs-title=""
                                    target="_blank">
                            ...
                            <div class="col-4 pt-2 "> 
                                <a href="{{$empresa->tikTok}}" 
                                    class="btn btn-dark btn-sm vertical-align-middle" 
                                    data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                    data-bs-title=""
                                    target="_blank">
