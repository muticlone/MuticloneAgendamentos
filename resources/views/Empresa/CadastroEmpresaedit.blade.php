...
@section('conteudo')
    ...
    <div class="col-md-8 offset-md-2 pt-2">
        <form action="/empresa/edit/{{ $empresa->id }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">
                                ...
                                <svg data-bs-toggle="tooltip" data-bs-placement="bottom"
                                    data-bs-title="Digite número do seu cnpj" xmlns="http://www.w3.org/2000/svg"
                                    width="14" height="14" fill="currentColor" class="bi bi-building-fill"
                                    viewBox="0 0 16 16">
                                    <path
                            ...
                            <input type="text" class="form-control" id="cnpj" name="cnpj_cpf" placeholder="Cnpj"
                                maxlength="18" OnKeyPress="formatar('##.###.###/####-##', this)"
                                value="{{ $empresa->cnpj_cpf }}" aria-describedby="validationTooltipUsernamePrepend"
                                required />
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="tel" class="form-control" id="Celular" name="celular"
                                placeholder="Celular" maxlength="13" onkeypress="formatar('##-#####-###', this)"
                                aria-describedby="validationTooltipUsernamePrepend" required
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="cep" name="cep" placeholder="Cep"
                                onblur="pesquisacep(this.value);" OnKeyPress="formatar('#####-###', this)" size="10"
                                maxlength="9" value="{{ $empresa->cep }}"
                                aria-describedby="validationTooltipUsernamePrepend" required />
                            <div class="invalid-tooltip">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="logradouro" name="logradouro"
                                placeholder="Logradouro" required value="{{ $empresa->logradouro }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="complemento" name="complemento"
                                placeholder="Complemento" value="{{ $empresa->complemento }}" />
                        </div>
                ...
                <div class="col-lg-3 col-sm-12 col-md-12 pt-2 ">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="txt" class="form-control" id="numero_endereco" name="numero_endereco"
                                placeholder="N°" required aria-describedby="validationTooltipUsernamePrepend"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-12 col-sm-12 col-md-12 pt-2 ">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <textarea class="form-control" name="descricao" rows="3" placeholder="Descrição sobre seu negócio"
                                        minlength="63" maxlength="250" aria-describedby="validationTooltipUsernamePrepend" required>{{ $empresa->descricao }}</textarea>
                                    <div class="invalid-tooltip">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="instagram" name="instagram"
                                            placeholder="Link do seu perfil" value="{{ $empresa->instagram }}" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="youtube" name="youtube"
                                            placeholder="Link do seu canal" value="{{ $empresa->youtube }}" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3 ">
                                        ...
                                        <input type="url" class="form-control" id="facebook" name="facebook"
                                            placeholder="Link do seu perfil" value="{{ $empresa->facebook }}" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="tikTok" name="tikTok"
                                            placeholder="Link do seu perfil" value="{{ $empresa->tikTok }}" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="site" name="site"
                                            placeholder="Link do seu Site" value="{{ $empresa->site }}" />
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="url" class="form-control" id="linkedin" name="linkedin"
                                            placeholder="Link do seu perfil" value="{{ $empresa->linkedin }}" />
                                    </div>
