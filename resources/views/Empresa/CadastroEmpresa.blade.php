                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text bg-success colorspancadastrodeempresa" id="basic-addon1">
                            <svg data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                ...
                                xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-whatsapp mx-1" viewBox="0 0 16 16">
                ...
                <div class="row g-12"> 
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12 "> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text bg-info colorspancadastrodeempresa" id="basic-addon1">
                                    <svg
                                        data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                        data-bs-title="Digite Link do seu perfil no Instagram" 
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram mx-1" viewBox="0 0 16 16">
                                ...
                                <input type="url" class="form-control" id="instagram" 
                                 name="instagram" placeholder ="Link do seu perfil"/>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12 "> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text bg-danger colorspancadastrodeempresa" id="basic-addon1">
                                    <svg
                                        data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                        data-bs-title=" Digite link do seu canal no Youtube"  
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-youtube mx-1" viewBox="0 0 16 16">
                                ...
                                <input type="url" class="form-control" id="youtube" 
                                 name="youtube" placeholder ="Link do seu canal"/>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3 ">
                                <span class="input-group-text bg-primary colorspancadastrodeempresa"  id="basic-addon1">
                                    <svg 
                                        data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                        data-bs-title=" Digite link do seu perfil no facebook "  
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook mx-1 " viewBox="0 0 16 16">
                                ...
                                <input type="url" class="form-control" id="facebook" 
                                 name="facebook" placeholder ="Link do seu perfil"/>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text bg-dark colorspancadastrodeempresa" id="basic-addon1">
                                    <svg
                                        data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                        data-bs-title=" Digite link do seu perfil no TikTok "   
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tiktok mx-1" viewBox="0 0 16 16">
                                ...
                                <input type="url" class="form-control" id="tikTok" 
                                 name="tikTok" placeholder ="Link do seu perfil"/>
                            </div>
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-12"> 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text bg-secondary colorspancadastrodeempresa " id="basic-addon1">
                                    <svg data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                    data-bs-title="Digite link do seu site ." 
                                        xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-globe-americas mx-1" viewBox="0 0 16 16">
                                        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM2.04 4.326c.325 1.329 2.532 2.54 3.717 3.19.48.263.793.434.743.484-.08.08-.162.158-.242.234-.416.396-.787.749-.758 1.266.035.634.618.824 1.214 1.017.577.188 1.168.38 1.286.983.082.417-.075.988-.22 1.52-.215.782-.406 1.48.22 1.48 1.5-.5 3.798-3.186 4-5 .138-1.243-2-2-3.5-2.5-.478-.16-.755.081-.99.284-.172.15-.322.279-.51.216-.445-.148-2.5-2-1.5-2.5.78-.39.952-.171 1.227.182.078.099.163.208.273.318.609.304.662-.132.723-.633.039-.322.081-.671.277-.867.434-.434 1.265-.791 2.028-1.12.712-.306 1.365-.587 1.579-.88A7 7 0 1 1 2.04 4.327Z"/>
                                    </svg>
                                   Site
                                </span>
                                <input type="url" class="form-control" id="site" 
                                 name="site" placeholder ="Link do seu Site"/>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text bg-primary colorspancadastrodeempresa " id="basic-addon1">
                                    <svg
                                        data-bs-toggle="tooltip" data-bs-placement="bottom" 
                                        data-bs-title=" Digite link do seu perfil no TikTok "  
                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin mx-1" viewBox="0 0 16 16">
                                ...
                                <input type="url" class="form-control" id="linkedin" 
                                 name="linkedin" placeholder ="Link do seu perfil"/>
                            </div>
