...
<div>
    <div class="col-lg-12 col-sm-12 col-md-12 pt-2" align="center">
        <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <a href="{{ route('meus.clientes.agendamentosdetalhesempresa',['id' => $empresa_id]) }}" class="btn btn-sm btn-outline-warning btndashboardservico">Em Andamento</a>
            <a href="{{ route('meus.agendamentos.aguardandoconfirmacao',['id' => $empresa_id]) }}" class="btn btn-sm btn-outline-warning btndashboardservico">Aguardando Confirmar</a>
